...
export default function SurgeryDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={cn(
        "glass-card rounded-xl p-4 border-l-4 border-orange-500 transition-opacity",
        surgery.status !== "aguardando" && "opacity-40 pointer-events-none"
      )}>
        ...
        <Textarea
          ...
          rows={2}
          className="text-sm"
          disabled={surgery.status !== "aguardando"}
        />
      </div>
