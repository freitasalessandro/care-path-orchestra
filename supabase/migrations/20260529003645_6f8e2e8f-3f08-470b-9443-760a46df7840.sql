-- Ajustar chaves estrangeiras para apontarem para sisapi_profiles e manter cascade
...
FOREIGN KEY (user_id) REFERENCES public.sisapi_profiles(id) ON DELETE CASCADE;
...
FOREIGN KEY (uploaded_by) REFERENCES public.sisapi_profiles(id) ON DELETE CASCADE;
...
FOREIGN KEY (created_by) REFERENCES public.sisapi_profiles(id) ON DELETE CASCADE;
...
FOREIGN KEY (author_id) REFERENCES public.sisapi_profiles(id) ON DELETE CASCADE;

ALTER TABLE public.sisapi_documents 
DROP CONSTRAINT IF EXISTS sisapi_documents_assigned_to_fkey,
ADD CONSTRAINT sisapi_documents_assigned_to_fkey 
FOREIGN KEY (assigned_to) REFERENCES public.sisapi_profiles(id) ON DELETE CASCADE;